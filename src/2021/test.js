...
describe('Advent of Code 2021', () => {
  ...
  describe('day 9', () => {
    it('passes part 1', () => {
      const answer = day9.part1();
      expect(answer).toEqual(439);
    });

    it('passes part 2', () => {
      const answer = day9.part2();
  ...
  describe('day 10', () => {
    it('passes part 1', () => {
      const answer = day10.part1();
      expect(answer).toEqual(387363);
    });

    it('passes part 2', () => {
      const answer = day10.part2();
  ...
  describe('day 11', () => {
    it('passes part 1', () => {
      const answer = day11.part1();
      expect(answer).toEqual(1591);
    });

    it('passes part 2', () => {
      const answer = day11.part2();
